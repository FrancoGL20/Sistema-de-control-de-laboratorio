                ...
                <table class="table-auto rounded-xl border border-slate-300">
                    ...
                    <tbody class="bg-white rounded-lg">
                        ...
                        <tr>
                            ...
                            <td
                                class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm font-medium text-gray-400 sm:pl-6 lg:pl-8 text-center">
                                <?=$certificado['nombre']?>
                            </td>
                            <td
                                class="whitespace-nowrap border-b border-gray-200 py-4 pl-4 pr-3 text-sm font-medium text-gray-400 sm:pl-6 lg:pl-8 flex justify-center">
