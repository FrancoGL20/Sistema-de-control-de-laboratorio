...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
        ...
        if (!$hay_errores) {
            $query_modificacion="UPDATE equipo_laboratorio SET tiene_garantia='$tiene_garantia',clave_mantenimiento='$clave_mantenimiento',marca='$marca',no_factura='$no_factura',nombre='$nombre',fecha_compra='$fecha_compra',fecha_ultimo_mantenimiento='$fecha_ultimo_mantenimiento',descripcion='$descripcion',modelo='$modelo',estado=$estado $parte_query_garantia WHERE id_equipo=$id;";
