            ...
            <form method="post" action="">
                ...
                <div class="mb-4">
                    ...
                    <select name="tipoEquipo" class="shadow appearance-none border border-slate-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" required>
                        <option value="1" selected>Alveógrafo</option>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="fechaCompra" class="shadow appearance-none border border-slate-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" value="2017-08-01" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="fechaUltimoMantenimiento" class="shadow appearance-none border border-slate-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" value="2017-08-01" required>
                </div>
