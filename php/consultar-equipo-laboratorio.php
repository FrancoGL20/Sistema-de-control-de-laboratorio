        ...
        <div class="w-96 mt-5">
            ...
            <form action="" method="">
                <div class="mb-4">
                    ...
                    <input type="text" name="euipo" list="clientes" class="shadow appearance-none border border-slate-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500" placeholder="Escriba el nombre y modelo del equipo..." required>
                </div>
                ...
                <datalist id="clientes">
                    <option value="1">Samsung 100T</option>
                    <option value="2">Marca y modelo</option>
                </datalist>
            </form>
        </div>
        <div class="mt-7">
